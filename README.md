# AnimatorSync
UPM Package for syncing Animators between screens. Supports PUN2.


The package exposes a component AnimatorSyncPUN (for PUN 2).
...
Triggers are handled via reliable RPC messages (PUN RPCs) because triggers are one-shot.
